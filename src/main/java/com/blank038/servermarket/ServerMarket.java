...
/**
 * Global market plugin for Bukkit. (version: 1.8 ~ 1.16)
 *
 * @author Blank038
 */
public class ServerMarket extends JavaPlugin {
	...
	public Blank038ApiLite blankapi;
	...
	public void onEnable() {
		...
		//////////////////// MrXiaoM 增加 START ////////////////////
		// 初始化 Blank038API Lite
		blankapi = new Blank038ApiLite(this, version);
		//////////////////// MrXiaoM 增加 END ////////////////////
		// 初始化经济桥
		...
		//////////////////// MrXiaoM 增加 START ////////////////////
		getLogger().info("本插件由 MrXiaoM 进行修改，移除了需要 PokemonAPI 的特性");
		//////////////////// MrXiaoM 增加 END ////////////////////
	}
